...
Onde a speed máxima permitida na rodovia é 90 Km/h e a mínima 30 Km/h
-O programa deve capturar a speed do usuário por terminal, caso a resposta esteja em branco o programa deve indicar que a speed não foi fornecida
-Caso o usuário esteja abaixo da speed o programa deve retornar que o carro está muito lento e que o usuário deve mudar de mão
-Caso o usuário esteja acima da speed o programa deve computar uma trafficTicket para o usuário, sendo o valor dessa trafficTicket o excesso de speed * 7
-Caso a speed não seja fornecida pelo usuário o programa deve sortear um numero entre 1 e 120 e aplicar a mecânica acima com o numero sorteado
-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
'''